...
class PaymentCheckoutScreen extends StatefulWidget {
  const PaymentCheckoutScreen({super.key,required this.api,required this.doctorName,required this.appointmentAt,required this.mode,this.amount=499,this.appointmentId});
  final ApiService api; final String doctorName; final DateTime appointmentAt; final String mode; final int amount; final String? appointmentId;
